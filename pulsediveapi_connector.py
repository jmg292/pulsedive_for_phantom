...
# from pulsediveapi_consts import *
import requests
import json
...
class PulsediveApiConnector(BaseConnector):

    def __init__(self):

        # Call the BaseConnectors init first
        super(PulsediveApiConnector, self).__init__()
    ...
    def _handle_lookup_indicator(self, param):
        # Implement the handler here
        # use self.save_progress(...) to send progress messages back to the platform
        self.save_progress("In action handler for: {0}".format(self.get_action_identifier()))
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'lookup_indicator':
            ret_val = self._handle_lookup_indicator(param)
...
def main():
    ...
    if username and password:
        try:
            login_url = PulsediveApiConnector._get_phantom_base_url() + '/login'
    ...
    with open(args.input_test_json) as f:
        ...
        connector = PulsediveApiConnector()
